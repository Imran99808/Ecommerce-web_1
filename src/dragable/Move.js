   ...
   function click(e){
    ...
    function downHandaler(e){
      ...
      e.preventDefault();
        ...
        setSposition((e.nativeEvent.clientX-parentElement.current.offsetLeft)-position);
        setSmoth(false);
    ...
    function moveHandaler(e){
        if(clicked){
            ...
            setPosition((e.nativeEvent.clientX-parentElement.current.offsetLeft)-sPosition);
    ...
    function positioncheck(){
      ...
      useEffect(()=>{
        ...
        setItem(parseInt( parentElement.current.offsetWidth/iShow));
         ...
         const handaleResize=()=> console.log('okk');
//setItem(parseInt( parentElement.current.offsetWidth/iShow));
